export {};
// core/profile-ui.js
// Profil Ã¶nizleme, banner yÃ¼kleme/kaldÄ±rma, Ã¼ye profil popup

// â”€â”€ Profil Ã–nizleme â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Banner YÃ¼kleme / KaldÄ±rma â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
async function uploadProfileBanner(input) {
  ...
  try {
    ...
    if (!r.ok) { toast(data.error || 'YÃ¼kleme baÅŸarÄ±sÄ±z', 'error'); return; }
    if (me) me.bannerUrl = data.bannerUrl;
    toast('Banner gÃ¼ncellendi! ğŸ¨', 'success');
    updateProfilePreview();
...
async function removeProfileBanner() {
  try {
    ...
    if (!r.ok) { toast('KaldÄ±rÄ±lamadÄ±', 'error'); return; }
...
// â”€â”€ Ãœye Profil Popup â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <div style="padding:12px">
      ...
      <div style="display:flex;gap:6px;margin-top:10px">
        ${!isMe ? `<button class="btn btn-primary" style="flex:1;padding:7px;font-size:12px"
          onclick="openDmWithUser('${userId}','${escHtml(displayName)}','${cssColor(avatarColor)}')">ğŸ’¬ DM</button>` : ''}
        ${!isMe ? `<button class="btn" style="padding:7px;font-size:12px;background:var(--bg-3);color:#ed4245;border:1px solid #ed4245" title="Engelle"
          onclick="document.querySelector('.member-profile-popup')?.remove();_blockUser('${userId}','${escHtml(displayName)}')">ğŸš«</button>` : ''}
      </div>
