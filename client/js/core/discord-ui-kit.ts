...
// Bridge Design System â€” UI bileÅŸen kÃ¼tÃ¼phanesi
// Butonlar, Select menÃ¼ler, Badge, Tooltip, Divider, Switch, Modal aksiyonlarÄ±
// TÃ¼m bileÅŸenler Bridge CSS token'larÄ±nÄ± kullanÄ±r (tokens.css) â€” temayÄ± destekler
// NOT: Bu dosya Discord'dan tamamen baÄŸÄ±msÄ±z Bridge Ã¶zel tasarÄ±m sistemidir.

'use strict';

/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   BUTON BÄ°LEÅENÄ°
   KullanÄ±m: BridgeUI.button({ label, style, emoji, disabled, onClick })
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   SELECT MENÃœ BÄ°LEÅENÄ°
   KullanÄ±m: BridgeUI.select({ options, value, placeholder, onChange })
   options: [{ value, label, emoji, description, disabled }]
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
const BridgeUISelect = {
  create({ options = [], value = '', placeholder = 'SeÃ§iniz...', onChange = null, id = '', multiple = false, maxValues = 1, disabled = false } = {}) {
    const wrap = document.createElement('div');
    wrap.className = `dui-select${disabled ? ' dui-select--disabled' : ''}`;
    if (id) wrap.id = id;

    // SeÃ§ili deÄŸerleri takip et
    ...
    function renderOptions() {
      ...
      options.forEach(opt => {
        ...
        html += '</div>';
        if (selected.has(opt.value)) html += `<span class="dui-select__opt-check" aria-hidden="true">âœ“</span>`;
    ...
    function open() {
      ...
      // EkranÄ±n dÄ±ÅŸÄ±na taÅŸarsa yukarÄ± aÃ§
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   BADGE BÄ°LEÅENÄ°
   KullanÄ±m: BridgeUI.badge({ text, color, size })
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   TOOLTIP BÄ°LEÅENÄ°
   KullanÄ±m: BridgeUI.tooltip(element, { text, position })
...
const BridgeUITooltip = {
  ...
  // data-tooltip attribute'larÄ±nÄ± otomatik iÅŸle
  initAutoTooltips() {
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   ACTION ROW (Discord Mesaj BileÅŸenleri - Buton SatÄ±rÄ±)
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
...
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
const BridgeUIModal = {
  confirm({ title = 'Emin misiniz?', description = '', confirmLabel = 'Onayla', cancelLabel = 'Ä°ptal', danger = false, onConfirm, onCancel } = {}) {
...
(function injectDUIStyles() {
  ...
  style.id = 'dui-styles';
  style.textContent = `
    /* â”€â”€â”€ BUTON â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    .dui-btn {
    ...
    /* â”€â”€â”€ ACTION ROW â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    .dui-action-row { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 8px; }

    /* â”€â”€â”€ SELECT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    ...
    /* â”€â”€â”€ TOOLTIP â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    .dui-tooltip {
    ...
    /* â”€â”€â”€ DÄ°VÄ°DER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    .dui-divider {
      display: flex; align-items: center; gap: 8px;
    ...
    /* â”€â”€â”€ SWITCH â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
window.BridgeUI = {
  ...
  // Mevcut DOM'daki data-tooltip attribute'larÄ±nÄ± iÅŸle
  initTooltips: () => BridgeUITooltip.initAutoTooltips(),
};

// DOM hazÄ±r olunca auto-tooltip'leri baÅŸlat
...
console.log('[BridgeUI] Discord UI Kit yÃ¼klendi âœ“');
