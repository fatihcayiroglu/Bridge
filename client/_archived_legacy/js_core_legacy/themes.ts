...
//
// Yerine geçen: client/js/core/ThemesPanel.svelte
//              client/js/core/themes-svelte.ts (mount shim)
//
// BridgeRegistry kayıtları shim dosyasında korunuyor.
// Silinme planı: Sprint 118
//
// core/themes.ts
// Modül: Yeni Temalar — Sunset (turuncu) + Forest (yeşil)
// Skeleton loading CSS, search highlight ve virtual scroll trigger stilleri de dahil.
...
// Sunset & Forest theme definitions are registered in theme.js + settings-modal.html.
// This module only injects auxiliary CSS (skeleton, highlight, virtual scroll).
