...
//
// Yerine geçen: client/js/core/ChannelPermsDataPanel.svelte
//              client/js/core/channel-perms-data-svelte.ts (mount shim)
//
// BridgeRegistry kayıtları shim dosyasında korunuyor.
// Silinme planı: Sprint 118
//
// client/js/core/channel-perms-data.ts
// ══════════════════════════════════════════════════
...
export const ALL_PERMS = PERM_GROUPS.flatMap(g => g.perms);

// İzin biti → label haritası (audit log ve inheritance popup'ında kullanılır)
export const BIT_LABELS: Record<number, string> = {};
