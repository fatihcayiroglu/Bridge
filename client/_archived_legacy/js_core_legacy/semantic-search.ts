...
//
// Yerine geçen: client/js/core/SemanticSearchPanel.svelte
//              client/js/core/semantic-search-svelte.ts (mount shim)
//
// BridgeRegistry kayıtları shim dosyasında korunuyor.
// Silinme planı: Sprint 118
//

// client/js/core/semantic-search.ts
// Semantic Arama UI — Bridge'in en güçlü arama özelliği
// "Bu haftaki proje kararları?" gibi doğal dil sorguları

import { BridgeRegistry } from './bridge-registry.js';
import { getAPI, getCurrentChannel } from './globals';
...
export const getBridgeSemanticSearch = () => BridgeRegistry.get('BridgeSemanticSearch');
