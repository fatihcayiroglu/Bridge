...
jest.mock('../routes/auth', () => ({
  sanitizeUser: (u) => ({ _id: u._id, username: u.username, displayName: u.displayName, avatarColor: u.avatarColor || '#5865f2', avatarUrl: u.avatarUrl || null }),
  router: { use: jest.fn() },
}));
...
const gdmRouter = require('../routes/groupDm');
