// server/tests/gdm-socket.test.js
...
const { registerGroupDmHandlers } = require('../socket/handlers/dm');
...
async function setupGroup(overrides = {}) {
  ...
  const user = makeUser({ displayName: 'Alice', avatarColor: '#5865f2', ...overrides });
